...
const MIGRATIONS = [
  ...
  {
    load: () => readFile(new URL("../../migrations/017_target_runs.sql", import.meta.url), "utf8"),
    version: 17,
  },
  {
    load: () =>
  ...
  {
    load: () =>
      readFile(new URL("../../migrations/019_target_run_reasoning.sql", import.meta.url), "utf8"),
    version: 19,
  },
];
