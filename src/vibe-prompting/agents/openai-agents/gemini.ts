/** Preserves Gemini continuation signatures across the OpenAI Agents SDK streaming boundary. */
...
import { readGeminiThoughtSignatureFromExtraContent } from "../../clients/llm/gemini.ts";
...
function captureStreamSignatures(
  ...
  for (const choice of choices) {
    ...
    for (const toolCall of toolCalls) {
      ...
      const signature = readGeminiThoughtSignatureFromExtraContent(toolCall.extra_content);
